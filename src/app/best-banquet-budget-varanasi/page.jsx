...
async function getOnexBanquetData() {
    try {
        const res = await fetch(
            'https://www.inforbit.in/demo/hotel-elegance-backend/api/banquets/onex-banquet',{ cache: "no-store" }
        ); 
        if (!res.ok) {
...
async function getSapphireBanquetData() {
    try {
        const res = await fetch(
            'https://www.inforbit.in/demo/hotel-elegance-backend/api/banquets/sapphire-banquet',{ cache: "no-store" }
        );
